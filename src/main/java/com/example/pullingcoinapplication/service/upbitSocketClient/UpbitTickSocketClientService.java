...
@Slf4j
public class UpbitTickSocketClientService implements SocketClientOnFailSubscriber {
    ...
    public void setPubSub() throws URISyntaxException {
        ...
        // todo : 이거 고치기 빼기.
        sessionMap = taskMap.get(TaskType.UPBIT_TICK);
    }
    ...
    private TextMessage getInitialMessage(UpbitCoinCode[] coins) {
        ...
        log.info("payload: {}", "[{\"ticket\":\"give_me_ticks\"},{\"type\":\"trade\",\"codes\":[" + payload.substring(0, payload.length() - 1) + "]}]");
