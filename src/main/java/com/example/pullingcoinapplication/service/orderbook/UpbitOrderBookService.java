...
import com.example.pullingcoinapplication.repository.upbitOrderBookRepository.*;
...
class UpbitOrderbookRepositoryPicker {
    ...
    UpbitOrderbookCommonRepository getRepository(UpbitOrderbook orderbook) {
        return getRepository(UpbitCodeUtil.getCoinCodeFromString(orderbook.getCode()));
    }

    UpbitOrderbookCommonRepository getRepository(String code) {
        return getRepository(UpbitCodeUtil.getCoinCodeFromString(code));
    }
